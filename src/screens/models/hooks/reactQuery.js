...
export const getSheetsMetadata = (token, url) => {
  ...
  const {
    ...
    error,
  } = useQuery(sheetsQueryKey, fetchSheetsMetadata, {
    enabled: false,
  });
  return {
    data: data,
...
export const validateSheetRange = (token, url, range) => {
  ...
  const {
    ...
    error,
  } = useQuery(sheetsQueryKey, fetchSheetsValidRange, {
    enabled: false,
  });
  return {
    data: data,
...
export const getModelsList = (token) => {
  const fetchModelsListdata = async () => {
    ...
    const response = await API.get("/admin/models-list/", config);
    return response.data;
  };
  ...
  const {
    ...
    isFetching,
  } = useQuery(sheetsQueryKey, fetchModelsListdata, {
    refetchOnWindowFocus: false,
    refetchOnMount: true, // Disable automatic fetch on mount
    staleTime: Infinity,
    retry: 3,
...
export const getCeleryIntervals = (token) => {
  const fetchCeleryData = async () => {
    ...
    const response = await API.get("admin/celery/schedules/", config);
    return response.data;
  };
  ...
  const {
    ...
    isFetching,
  } = useQuery(sheetsQueryKey, fetchCeleryData, {
    refetchOnWindowFocus: false,
    refetchOnMount: true, // Disable automatic fetch on mount
    staleTime: Infinity,
    retry: 3,
...
export const getScheduledCronActions = (token, queryParams) => {
  const fetchCronActions = async () => {
    ...
    const response = await API.get("admin/admin-cron-actions/schedules/", {
      params: queryParams,
      ...config,
    });
    return response.data;
  ...
  const {
    ...
    isFetching,
  } = useQuery(sheetsQueryKey, fetchCronActions, {
    refetchOnWindowFocus: false,
    refetchOnMount: true, // Disable automatic fetch on mount
    staleTime: Infinity,
    retry: 3,
...
export const getActionTrace = (token, queryParams = {}) => {
  const fetchActionExecutionHistory = async () => {
    ...
    const response = await API.get(`admin/cron-actions/history/`, {
      params: queryParams,
      ...config,
    });
    return response.data;
  ...
  const {
    ...
    isFetching,
  } = useQuery(sheetsQueryKey, fetchActionExecutionHistory, {
    refetchOnWindowFocus: false,
...
export const getSheetsPreview = (token, queryParams) => {
  const fetchSheetsDataRangePreview = async () => {
    ...
    const response = await API.get(`admin/sheets/preview/`, {
      params: queryParams,
      ...config,
    });
    return response.data;
  ...
  const {
    ...
    isFetching,
  } = useQuery(sheetsQueryKey, fetchSheetsDataRangePreview, {
    refetchOnWindowFocus: false,
    refetchOnMount: true, // Disable automatic fetch on mount
    staleTime: Infinity,
    retry: 3,
...
export const getCronActionById = (token, queryParams) => {
  const fetchCronAction = async () => {
    ...
    const response = await API.get(`admin/get_cron_job/`, {
      params: queryParams,
      ...config,
    });
    return response.data;
  ...
  const {
    ...
    isFetching,
  } = useQuery(sheetsQueryKey, fetchCronAction, {
    refetchOnWindowFocus: false,
    refetchOnMount: true, // Disable automatic fetch on mount
    staleTime: Infinity,
    retry: 3,
...
export const getModelData = (token, model, queryParams) => {
  const fetchModelData = async () => {
    ...
    const response = await API.get(`model-data/get/${model}/data/`, {
      params: queryParams,
      ...config,
    });
    return response.data;
  ...
  const {
    ...
    isFetching,
    error,
  } = useQuery(sheetsQueryKey, fetchModelData, {
    enabled: false,
    retry: false,
    refetchOnMount: true,
  });
...
export const getModelRowRecord = (token, model, queryParams) => {
  ...
  const {
    ...
    isFetching,
    error,
  } = useQuery(sheetsQueryKey, fetchModelRowRecord, {
    retry: false,
    refetchOnMount: true,
    refetchOnWindowFocus: false,
    staleTime: Infinity,
