...
function UploadForm() {
  ...
  return (
    <form className="w-full overflow-x-auto col-span-10">
      <header
        id="alert-3"
      ...
      >
        ...
        <div className="ml-3 text-sm font-medium">
          Schedule automatic uploads from{" "}
          <Link
            to={`/models/${model}/uploads/scheduler`}
            className="font-semibold underline hover:no-underline"
          >
            spreadsheets{" "}
          </Link>
          or manually upload your csv file below.
        </div>
        <button
          type="button"
