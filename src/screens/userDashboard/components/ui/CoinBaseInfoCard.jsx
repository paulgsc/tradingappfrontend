...
import CoinAccessInfo from "./CoinAccessInfo";

function CoinBaseInfoCard() {
  ...
  return (
    <TabMenu className={"w-full max-w-lg"}>
      <TabMenu.List
        className={
...
export default CoinBaseInfoCard;
