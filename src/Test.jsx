      ...
      <div className="w-full max-w-lg mx-auto">
        ...
        <div className="bg-white shadow-2xl rounded-b-3xl">
          ...
          <div className="w-5/6 m-auto">
            <p className="text-center text-neutral-500 pt-1.5">
              You are creating a coinbase third party app, click the link begin
              to begin the ouath process.
            </p>
          </div>
          ...
          <div className="flex flex-1 justify-center mt-2.5">
            <div className="w-11/12 bg-neutral-100 border border-gray-200 rounded-lg shadow">
              ...
              <div className="flow-root sm:p-4 shadow-inner">
                <ul
                  role="list"
                  className="h-32  p-1.5 overflow-y-auto no-scrollbar divide-y divide-gray-200 bg-gray-50"
                >
          ...
          <div className="bg-blue-500 w-72 lg:w-5/6 m-auto mt-6 p-2 hover:bg-blue-700 rounded-2xl  text-white text-center shadow-xl shadow-bg-blue-700">
