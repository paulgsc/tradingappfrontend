  ...
  if (token) {
    return (
      <div className="group relative">
        ...
        <div className="hidden md:group-focus-within:block overflow-hidden z-50 absolute top-6 right-6 my-4 w-96 text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg">
          <div className="inline-flex flex-1 w-full items-center justify-between py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 ">
            <span> Notifications</span>
            <Link
              className=" p-2 rounded-full hover:bg-gray-400/20"
